...
import { useMessagesList } from "@/domains/app/messages/messages.api";
...
import { Check, CircleDot, Eye, Inbox } from "lucide-react";
...
export default function MessagesPage() {
  ...
  const { messagesList, isLoading } = useMessagesList(
    appSlug,
    me?.devModeEnabled,
    filters.page,
    filters.status,
  ...
  const pagination = messagesList?.pagination;
      ...
      {isLoading ? (
        ...
        <>
          <DataTable
            ...
            onMessageIdChange={(id) => setFilters({ messageId: id })}
          />
